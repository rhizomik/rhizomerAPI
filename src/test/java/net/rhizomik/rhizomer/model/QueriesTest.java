...
public class QueriesTest {
    ...
    public void testNoAdditional2Samples() throws Exception {
        ...
        assertThat(StringUtils.countOccurrencesOf(selectsUnion, "\n"), Matchers.is(0));
        assertThat(selectsUnion, CoreMatchers.equalTo(""));
    }
    ...
    public void testOneAdditional2Sample() throws Exception {
        ...
        String selectsUnion = queries.addSamples(classCount, sampleSize, coverage);
        assertThat(StringUtils.countOccurrencesOf(selectsUnion, "\n"), Matchers.is(1));
        assertThat(selectsUnion, Matchers.containsString("OFFSET 5 LIMIT 2"));
    }
    ...
    public void testTwoAdditional2Samples() throws Exception {
        ...
        String selectsUnion = queries.addSamples(classCount, sampleSize, coverage);
        assertThat(StringUtils.countOccurrencesOf(selectsUnion, "\n"), Matchers.is(2));
        assertThat(selectsUnion, Matchers.containsString("OFFSET 4 LIMIT 2"));
        assertThat(selectsUnion, Matchers.containsString("OFFSET 8 LIMIT 2"));
    }
    ...
    public void testNoAdditional1Samples() throws Exception {
        ...
        String selectsUnion = queries.addSamples(classCount, sampleSize, coverage);
        assertThat(StringUtils.countOccurrencesOf(selectsUnion, "\n"), Matchers.is(0));
        assertThat(selectsUnion, Matchers.is(""));
    }
    ...
    public void testOneAdditional1Sample() throws Exception {
        ...
        String selectsUnion = queries.addSamples(classCount, sampleSize, coverage);
        assertThat(StringUtils.countOccurrencesOf(selectsUnion, "\n"), Matchers.is(1));
        assertThat(selectsUnion, Matchers.containsString("OFFSET 5 LIMIT 1"));
    }
    ...
    public void testThreeAdditional1Samples() throws Exception {
        ...
        String selectsUnion = queries.addSamples(classCount, sampleSize, coverage);
        assertThat(StringUtils.countOccurrencesOf(selectsUnion, "\n"), Matchers.is(3));
        assertThat(selectsUnion, Matchers.containsString("OFFSET 3 LIMIT 1"));
        assertThat(selectsUnion, Matchers.containsString("OFFSET 6 LIMIT 1"));
        assertThat(selectsUnion, Matchers.containsString("OFFSET 9 LIMIT 1"));
    }
